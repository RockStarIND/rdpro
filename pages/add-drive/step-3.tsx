...
export default function OAuthStep3({ 
  ...
  description, errorUri, principals, totalDownloads }) {
        ...
        <div className="mx-auto w-full max-w-5xl p-4">
          <div className="rounded-lg bg-white p-3 dark:bg-slate-900 dark:text-gray-100">
            <div className="mx-auto w-52">
              <LottiePlayer src="https://assets6.lottiefiles.com/packages/lf20_mbznsnmf.json" style={{height: "200px"}}/>
            </div>
            ...
            {error || accountAlreadyConnected ? (
              <div>
                ...
                <p className="my-2 whitespace-pre-line rounded-lg border border-gray-400/20 bg-gray-50 p-2 font-mono text-sm opacity-80 dark:bg-slate-900">
                  {
