...
export default function OAuthStep1({ totalDownloads }) {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white dark:bg-slate-900">
      ...
      <main className="flex w-full flex-1 flex-col bg-white dark:bg-slate-900">
        ...
        <div className="mx-auto w-full max-w-5xl p-4">
          <div className="rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100">
            <div className="mx-auto">
              <LottiePlayer src="https://assets7.lottiefiles.com/packages/lf20_zvKAYTsxBI.json" style={{height: "300px"}}/>
            </div>
            ...
            <div className="my-4 overflow-auto">
              <table className="min-w-full table-auto">
                <tbody>
                  <tr className="border bg-white dark:border-gray-700 dark:bg-slate-900">
                    <td className="border dark:border-gray-700 bg-gray-50 py-1 px-3 text-left text-xs font-medium uppercase tracking-wider text-gray-700 dark:bg-slate-900 dark:text-gray-400">
                      CLIENT_ID
                    </td>
...
// bug in react-i18next doesn't support special characters (like :, <, >)
// which causes server-side translation to mismatch the client-side
// see more:
// https://github.com/i18next/react-i18next/issues/964
