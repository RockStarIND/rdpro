...
export default function OAuthStep2({ totalDownloads }) {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white dark:bg-slate-900">
      ...
      <main className="flex w-full flex-1 flex-col bg-white dark:bg-slate-900">
        ...
        <div className="mx-auto w-full max-w-5xl p-4">
          <div className="rounded-lg bg-white p-3 dark:bg-slate-900 dark:text-gray-100">
            <div className="mx-auto w-52">
              <LottiePlayer src="https://assets10.lottiefiles.com/packages/lf20_ljx86sv6.json" style={{height: "200px"}}/>
            </div>
            ...
            <div
              className="relative my-2 cursor-pointer rounded-lg border border-gray-500/50 bg-gray-50 font-mono text-sm hover:opacity-80 dark:bg-slate-900"
              onClick={() => {
            ...
            <input
              className={`my-2 w-full flex-1 rounded-lg border bg-gray-50 p-2 font-mono text-sm font-medium focus:outline-none focus:ring dark:bg-slate-900 dark:text-white ${
                authCode
            ...
            <p className="my-2 overflow-hidden truncate rounded-lg border border-gray-400/20 bg-gray-50 p-2 font-mono text-sm opacity-80 dark:bg-slate-900">
