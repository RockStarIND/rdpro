    ...
    <div className="flex items-center space-x-2">
      <div className="w-56">
        ...
        <div className="relative mt-2">
          <div className="flex h-1 overflow-hidden rounded-lg bg-gray-100">
            <div style={{ width: `${progress}%` }} className="bg-gray-500 text-white transition-all duration-100"></div>
          </div>
        </div>
      </div>
      <button
        className="rounded-lg bg-red-500 p-2 text-white hover:bg-red-400 focus:outline-none focus:ring focus:ring-red-300"
