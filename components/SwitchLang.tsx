  ...
  return (
    <div className="relative">
      <Menu>
        ...
        >
          <Menu.Items className="absolute top-0 right-0 z-20 mt-8 w-28 divide-y divide-gray-900 overflow-auto rounded-lg border border-gray-900/10 bg-white py-1 shadow-lg focus:outline-none dark:border-gray-500/30 dark:bg-slate-900 dark:text-white">
            {locales!.map(locale => (
